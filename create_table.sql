...
CREATE TABLE Test_Agents (
    ...
    UNIQUE KEY idx_test_agents_1 ( agent_id, brand_id, group_id )
...
DROP TRIGGER IF EXISTS test_agents_before_insert;

delimiter $$
CREATE TRIGGER test_agents_before_insert BEFORE INSERT ON forecasts
  FOR EACH ROW BEGIN
